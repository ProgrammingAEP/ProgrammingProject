<?php
	...
	if (isset($_POST['register_btn'])) {
		...
		if ($password == $password2) {
			...
			$sql = "INSERT INTO members(fname, lname,username, email, password, doby, dobm, dobd, location) VALUES('$fname', '$lname', '$username', '$email', '$password', '$doby', '$dobm', '$dobd', '$location')";
			mysqli_query($db, $sql);
